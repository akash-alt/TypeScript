...
let arr = ["akash", "developer", 1, false]; // here we have define 2 datatypes (string,number)
arr.push(100);
arr.push(true);
...
let array: string[] = ["janny", "sum", "minus"];
array.push("coding");
console.log(array);
...
let array1: number[] = [1, 2, 334, 5, 45, 45]; // here have define array types
let array2: number = [1, 2, 334, 5, 45, 45]; // here [] bracket is missing
array1.push(12);
console.log(array1);
